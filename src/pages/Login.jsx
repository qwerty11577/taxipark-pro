...
export default function Login() {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            toast.error(err.detail || "Неверный email или пароль");
        } finally {
            setLoading(false);
        }
    };
                ...
                <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "24px", padding: "40px" }}>
                    ...
                    <div style={{ marginBottom: "20px" }}>
                        ...
                        <input
                            ...
                            style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "12px", padding: "14px 16px", color: "#fff", fontSize: "15px", outline: "none", fontFamily: "'Space Grotesk', sans-serif", boxSizing: "border-box" }}
                    ...
                    <button
                        ...
                        onClick={handleLogin}
                        disabled={loading}
                        style={{ width: "100%", padding: "16px", background: "linear-gradient(135deg, #f5c518, #ff8c00)", color: "#000", border: "none", borderRadius: "50px", cursor: "pointer", fontWeight: 700, fontSize: "16px", fontFamily: "'Space Grotesk', sans-serif", opacity: loading ? 0.7 : 1 }}>
                        {loading ? "Входим..." : "Войти →"}
                    </button>

                    <div style={{ textAlign: "center", marginTop: "24px", fontSize: "14px", color: "#444" }}>
                        Нет аккаунта?{" "}
                        <span onClick={() => navigate("/register")} style={{ color: "#f5c518", cursor: "pointer", fontWeight: 600 }}>Зарегистрироваться</span>
                    </div>
                </div>
